...
const namePrefix = "Killaroos Battalion";
const description = "A cheeky take on NFT's and a little politics";
...
const CONTRACT_NAME = 'Killaroos Battalion';
const CONTRACT_SYMBOL = 'KRSNFT';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0xfB7cF21c02304Fca25FbA6d3aE46E36F7e70094C';
const TREASURY_ADDRESS = '0xfB7cF21c02304Fca25FbA6d3aE46E36F7e70094C';
...
const ROYALTY_ADDRESS = "0xfB7cF21c02304Fca25FbA6d3aE46E36F7e70094C"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xfB7cF21c02304Fca25FbA6d3aE46E36F7e70094C"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "which killa will you get?"; // Replace with what you want the generic descriptions to say.
